...
F2k_2 = np.linalg.matrix_power(A, (n+2))[0,1]-1
print(F2k_2)

Fk = np.linalg.matrix_power(A, ((n+2)//2))

print((Fk[0,1]*(2*Fk[0, 0] - Fk[0, 1]))-1)
# F_k        F_k+1      F_k
...
import numpy as np
A = np.array([1,1,1,0], dtype=object).reshape(2,2)
Fk = np.linalg.matrix_power(A, (2000001))
